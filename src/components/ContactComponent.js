...
class Contact extends Component {
    ...
    handleSubmit(values) {
        ...
        alert("Current satte is: " + JSON.stringify(values));
                            ...
                            <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                                <Row className="form-group">
                                    ...
                                    <Col md={10}>
                                        ...
                                        <Errors className="text-danger" model=".firstname" show="touched" messages={{required:'Required',minLength:'Must Be greater than 2 characters', maxLength:'Must be 15 Characters or less'}}></Errors>
                                    </Col>
                                </Row>
                                <Row className="form-group">
                                    ...
                                    <Col md={10}>
                                        ...
                                        <Errors className="text-danger" model=".lastname" show="touched" messages={{required:'Required',minLength:'Must Be greater than 2 characters', maxLength:'Must be 15 Characters or less'}}></Errors>
                                    </Col>
                                </Row>
                                <Row className="form-group">
                                    ...
                                    <Col md={10}>
                                        ...
                                        <Errors className="text-danger" model=".telnum" show="touched" messages={{required:'Required',minLength:'Must Be greater than 2 numbers', maxLength:'Must be 15 Number or less', isNumber: 'Must Be a number'}}></Errors>
                                    </Col>
                                </Row>
                                <Row className="form-group">
